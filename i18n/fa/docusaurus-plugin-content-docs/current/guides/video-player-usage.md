...
:::important
سخت افزار برخی گوشی های قدیمی به صورت کامل از کدک `x265` *(HEVC و Nvidia)* پشتیبانی نمی کند، به همین دلیل مرورگر نمی تواند ویدیو را دیکود کند.<br />
...
در عین حال، برخی ویدیوهای با کیفیت بالا ممکن است دقیقا به همان سرعت مورد نظر نرسند. این به دلیل <u>باتل نک</u> (رسیدن به حداکثر توان سخت افزاری) دیکود است.
:::
